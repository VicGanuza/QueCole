		...
		<div class="row">
			...
			<div class="span9">
			 	<h3><?php if ($linea) {echo ' L&iacute;nea: '.$linea . ' - Sentido: '. $titulo; }
				      else { echo ' Visualice las paradas en el mapa ';}
					  ?> 
			    </h3>
			</div>
		</div>
					...
					<div class="accordion stacked2" id="accordion">
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse1" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=500&s=ida"> Sesquicentenario - Ing. White</a></div>
							  <div><a href="paradas.php?lin=500&s=vuelta"> Ing. White - Sesquicentenario</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse2" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=502&s=ida">V. Rosas - V. Floresta</a></div>
							  <div><a href="paradas.php?lin=502&s=vuelta">V. Floresta - V. Rosas</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse3" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=503&s=ida">Spurr - Wall Mart</a></div>
							  <div><a href="paradas.php?lin=503&s=vuelta"> Wall Mart - Spurr</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse4" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=504&s=ida">Ing. White - Hospital Penna</a></div>
							  <div><a href="paradas.php?lin=504&s=vuelta">Hospital Penna - Ing. White</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse5" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=505&s=ida">Rosendo L&oacute;pez - Noroeste</a></div>
							  <div><a href="paradas.php?lin=505&s=vuelta">Noroeste - Rosendo L&oacute;pez</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse6" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=506&s=ida">Rosendo L&oacute;pez - 17 de Mayo</a></div>
							  <div><a href="paradas.php?lin=506&s=vuelta">17 de Mayo - Rosendo L&oacute;pez</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse7" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							  <div><a href="paradas.php?lin=507&s=ida">Villa Hardin Green - Hospital Municipal</a></div>
							  <div><a href="paradas.php?lin=507&s=vuelta">Hospital Municipal - Villa Hardin Green</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse8" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=509&s=ida">Pq. de la ciudad - Bella Vista</a></div>
							  <div><a href="paradas.php?lin=509&s=vuelta">Bella Vista - Pq. de la ciudad</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse9" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=512&s=ida">Pq. de la ciudad - B. 5 de Abril</a></div>
							  <div><a href="paradas.php?lin=512&s=vuelta">B. 5 de Abril - Pq. de la ciudad</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse10" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=513&s=ida">Pq. de la ciudad - V. Don Bosco</a></div>
							  <div><a href="paradas.php?lin=513&s=vuelta">V. Don Bosco - Pq. de la ciudad</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse11" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=514&s=ida">Coca Cola - Maldonado</a></div>
							  <div><a href="paradas.php?lin=514&s=vuelta">Maldonado - Coca Cola</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse12" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=516&s=ida">Newton - Panam&aacute; al 3500</a></div>
							  <div><a href="paradas.php?lin=516&s=vuelta">Panam&aacute; al 3500 - Newton</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse13" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=517&s=ida">Pq. de la ciudad - Espora</a></div>
							  <div><a href="paradas.php?lin=517&s=vuelta">Espora - Pq. de la ciudad</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse14" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=518&s=ida">Spurr - Hospital Municipal</a></div>
							  <div><a href="paradas.php?lin=518&s=vuelta">Hospital Municipal- Spurr</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse15" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=519&s=ida">Bah&iacute;a Blanca - Cerri</a></div>
							  <div><a href="paradas.php?lin=519&s=vuelta">Cerri - Bah&iacute;a Blanca</a></div>
							</div>
						  </div>
						</div>
						...
						<div class="accordion-group">
						  ...
						  <div id="collapse16" class="accordion-body collapse" style="height: 0px;">
							<div class="accordion-inner">
							   <div><a href="paradas.php?lin=519A&s=ida">Predio Plaza - Patagonia</a></div>
							  <div><a href="paradas.php?lin=519A&s=vuelta">Patagonia - Predio Plaza</a></div>
							</div>
						  </div>
						</div>
