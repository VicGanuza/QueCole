...
function BuscarLocaciones()
 ...
 function PasanCerca(desde,hasta,distancia,l)
  { Limpiar(l);
	...
	var searchUrl = 'xml/xmlPasanLineas.php?latI=' + desde.lat() + '&lngI=' + desde.lng() + '&latD=' + hasta.lat() + '&lngD=' + hasta.lng() + '&radius=' + radius + '&l=' + l;

    downloadUrl(searchUrl, function(data)
	  {  var xml = parseXml(data);
         var pasa = xml.documentElement.getElementsByTagName("pasa_por_ambas");
		 if (pasa.length == 0) { crearOpcion(0,0); }
